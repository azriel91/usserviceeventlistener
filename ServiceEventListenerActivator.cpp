 ...
 */
class ServiceEventListenerActivator : public ModuleActivator {
...
private:
	...
	void Load(ModuleContext* context) {
		...
		context->AddServiceListener(this, &ServiceEventListenerActivator::ServiceChanged);
	}
	...
	void Unload(ModuleContext* context) {
		context->RemoveServiceListener(this, &ServiceEventListenerActivator::ServiceChanged);
